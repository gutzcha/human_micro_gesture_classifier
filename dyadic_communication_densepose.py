...
class DensposeDyadicvideoClsDataset(Dataset):
    ...
    def __init__(self, anno_path=None, data_path=None, mode='train', clip_len=2,
                 ...
                 view_crop_mapping=None, corner_crop_size=None, data_root=None, limit_data=None,densepose_extractor=None, args=None, **kwargs):
        ...
        self.densepose_extractor = densepose_extractor
        ...
        dataset_samples = df['filenames'].to_list()
    ...
    def __getitem__(self, index):
        if self.mode == 'train':
            ...
            # extract densepose
            if self.densepose_extractor is not None:
                buffer = self.densepose_extractor(buffer)
