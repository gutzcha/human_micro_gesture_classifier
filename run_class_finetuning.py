...
def main(args, ds_init):
    ...
    try:
        ...
        # try:
        print('No test datset, trying to use val as test')
    ...
    if 'pos_weight_path' in args and args.pos_weight_path is not None:
        ...
        try:
            ...
            positive_weights = [entry['positive_weights'] for entry in positive_weights_dict['data']]
            positive_weights = torch.Tensor(positive_weights).to(device=device)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if data_loader_val is not None:
            ...
            if early_stop.early_stop(test_stats['loss']):
                break
