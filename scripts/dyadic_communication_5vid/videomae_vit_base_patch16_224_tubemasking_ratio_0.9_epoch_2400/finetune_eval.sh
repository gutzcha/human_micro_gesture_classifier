...
OUTPUT_DIR='/home/ubuntu/efs/videoMAE/scripts/dyadic_communication_5vid/videomae_vit_base_patch16_224_tubemasking_ratio_0.9_epoch_2400/eval'

# path to SSV2 annotation file (train.csv/val.csv/test.csv)
# DATA_PATH='YOUR_PATH/list_ssv2'
DATA_PATH='/home/ubuntu/efs/videoMAE/scripts/dyadic_communication_5vid/dataset'
...
MODEL_PATH='/home/ubuntu/efs/videoMAE/scripts/dyadic_communication_5vid/videomae_vit_base_patch16_224_tubemasking_ratio_0.9_epoch_2400/checkpoint-best/mp_rank_00_model_states.pt'

POS_WEIGHTS_PATH='/home/ubuntu/efs/videoMAE/scripts/dyadic_communication_5vid/dataset/weights.json'
