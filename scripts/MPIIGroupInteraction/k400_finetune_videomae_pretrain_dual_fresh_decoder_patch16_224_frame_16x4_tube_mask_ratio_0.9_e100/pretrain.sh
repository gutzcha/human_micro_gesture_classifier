...
RUN_NAME='k400_finetune_videomae_pretrain_dual_fresh_decoder_patch16_224_frame_16x4_tube_mask_ratio_0.9_e100'
...
/opt/conda/envs/pytorch/bin/torchrun \
        ...
        --root='/videos/mpi_data/2Itzik/MPIIGroupInteraction/' \
        --lr=1.5e-4
