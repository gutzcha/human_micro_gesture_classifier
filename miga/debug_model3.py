...
OUTPUT_DIR = r'tmp'
EXPERIMENT_DIR = r'C:\Users\gutzc\GitHub\human_micro_gesture_classifier\miga\datasets\resampled_64'
MODEL_PATH = r'C:\Users\gutzc\GitHub\human_micro_gesture_classifier\miga\models\checkpoint-best.pth'
DATA_DIR = r'C:\Users\gutzc\GitHub\human_micro_gesture_classifier\miga_dataset\SMG_RGB_Phase1\split_files_video'

args = Namespace(multi_labels=True,
                 one_hot_labels=False, limit_data=2,
                 pos_weight_path=osp.join(EXPERIMENT_DIR,'dataset','weights.json'),
                 ...
                 lr=0.005, layer_decay=0.75,
                 warmup_lr=1e-04, min_lr=1e-06,
                 warmup_epochs=0, warmup_steps=-1,                 color_jitter=0.4, num_sample=1,
                 ...
                 data_path=osp.join(EXPERIMENT_DIR,'dataset'),
                 ...
                 data_root=DATA_DIR,
                 log_dir=OUTPUT_DIR,
                 device='cpu', seed=0, resume='', auto_resume=True, save_ckpt=True, start_epoch=0, eval=False,
